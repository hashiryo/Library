...
# :heavy_check_mark: test/aoj/2159.test.cpp

<a href="../../../index.html">Back to top page</a>

* category: <a href="../../../index.html#0d0c91c0cca30af9c1c9faef0cf04aa9">test/aoj</a>
* <a href="{{ site.github.repository_url }}/blob/master/test/aoj/2159.test.cpp">View this file on GitHub</a>
    - Last commit date: 2020-09-06 22:06:06+09:00


* see: <a href="http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2159">http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2159</a>
...
signed main() {
  ...
  auto check = [&](Line l) {
    ...
    for (Point p : ps) {
      cnt += l.where(p) == ON;
      p = l.reflect(p);
      if (sgn(p.x - round(p.x)) != 0 || sgn(p.y - round(p.y)) != 0)
        return false;
