...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/1107
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/1107
  bundledCode: "#line 1 \"test/aoj/1107.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1107\"\
    ...
    \ 0), d(0, 1);\n  for (int i= N; i--;) {\n   R mn= M_PI, dis= 1e10;\n   int nx=\
    \ -1;\n   for (int j= N; j--;) {\n    if (used[j]) continue;\n    R t= angle(ps[j]\
    \ - cur, d), a= dist2(cur, ps[j]);\n    if (mn > t) mn= t, nx= j, dis= a;\n  \
    \  else if (!sgn(mn - t))\n     if (dis > a) dis= a, nx= j;\n   }\n   d= ps[nx]\
    \ - cur, cur= ps[nx], used[nx]= true, ans+= sqrt(dis);\n  }\n  cout << ans <<\
    \ '\\n';\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1107\"\n#include\
  ...
  verifiedWith: []
documentation_of: test/aoj/1107.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/1107.test.cpp
- /verify/test/aoj/1107.test.cpp.html
