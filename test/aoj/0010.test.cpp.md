...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0010
    links:
    - https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0010
  bundledCode: "#line 1 \"test/aoj/0010.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0010\"\
    ...
    \ ls;\n}\n}\n#line 4 \"test/aoj/0010.test.cpp\"\nusing namespace std;\nsigned\
    \ main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n using namespace geo;\n cout\
    \ << fixed << setprecision(3);\n int n;\n cin >> n;\n while (n--) {\n  Point<long\
    \ double> p1, p2, p3;\n  cin >> p1 >> p2 >> p3;\n  auto c= circumscribed_circle(p1,\
    \ p2, p3);\n  cout << c.o.x << \" \" << c.o.y << \" \" << c.r << '\\n';\n }\n\
    \ return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0010\"\
  ...
  verifiedWith: []
documentation_of: test/aoj/0010.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0010.test.cpp
- /verify/test/aoj/0010.test.cpp.html
