...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/1023
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/1023
  bundledCode: "#line 1 \"test/aoj/1023.KDT.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1023\"\
    \n\n// \u5186\u5F62\u30AF\u30A8\u30EA\n\n#include <iostream>\n#include <vector>\n\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1023\"\n\n//\
    ...
    \ (int i= 0; i < BN; ++i) cin >> B[i][0] >> B[i][1];\n  KDTree<int, 2, RSQ> kdt(B,\
    \ 1);\n  long long ans= 0;\n  for (auto [x, y]: A) ans+= kdt.fold_ball(x, y, R\
    \ * 4);\n  cout << ans << '\\n';\n }\n return 0;\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/aoj/1023.KDT.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/1023.KDT.test.cpp
- /verify/test/aoj/1023.KDT.test.cpp.html
