...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0012
    links:
    - https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0012
  bundledCode: "#line 1 \"test/aoj/0012.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0012\"\
    ...
    \ return Polygon(ps);\n}\n}\n#line 4 \"test/aoj/0012.test.cpp\"\nusing namespace\
    \ std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n using namespace\
    \ geo;\n Point<long double> p1, p2, p3, p;\n while (cin >> p1 >> p2 >> p3 >> p)\
    \ {\n  Polygon<long double> g({p1, p2, p3});\n  cout << (g.where(p) == 1 ? \"\
    YES\" : \"NO\") << '\\n';\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0012\"\
  ...
  verifiedWith: []
documentation_of: test/aoj/0012.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0012.test.cpp
- /verify/test/aoj/0012.test.cpp.html
