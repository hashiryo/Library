...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/2763.RH.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2763\"\
    ...
    \ + n; ++i) ret+= (char)str[i];\n  return ret;\n }\n};\n#line 9 \"test/aoj/2763.RH.test.cpp\"\
    \nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using Mint= ModInt<int(1e9) + 7>;\n using K= CartesianProduct<Mint, Mint>;\n\
    \ using RH= RollingHash<K>;\n RH::init({rng(), rng()});\n string S;\n cin >> S;\n\
    \ int n= S.length();\n RH rh(S);\n int ans= -1;\n for (int i= 1; i * 3 < n; ++i)\
    \ {\n  if ((n & 1) != (i & 1)) continue;\n  int j= (n - i) / 2;\n  if (rh.sub(0,\
    \ j) != rh.sub(j, j)) continue;\n  if (rh.sub(0, i) != rh.sub(j + j, i)) continue;\n\
    \  ans= j;\n }\n cout << (ans < 0 ? \"mitomerarenaiWA\" : \"Love \" + S.substr(0,\
    \ ans) + \"!\") << '\\n';\n return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2763\"\n#include\
    ...
    \ i) != rh.sub(j + j, i)) continue;\n  ans= j;\n }\n cout << (ans < 0 ? \"mitomerarenaiWA\"\
    \ : \"Love \" + S.substr(0, ans) + \"!\") << '\\n';\n return 0;\n}"
  dependsOn:
  - src/Math/ModInt.hpp
  ...
  verifiedWith: []
documentation_of: test/aoj/2763.RH.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/2763.RH.test.cpp
- /verify/test/aoj/2763.RH.test.cpp.html
