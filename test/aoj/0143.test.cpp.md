...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0143
    links:
    - https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0143
  bundledCode: "#line 1 \"test/aoj/0143.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0143\"\
    ...
    \ return Polygon(ps);\n}\n}\n#line 5 \"test/aoj/0143.test.cpp\"\nusing namespace\
    \ std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n using namespace\
    \ geo;\n int n;\n cin >> n;\n while (n--) {\n  Point<int> p1, p2, p3, k, s;\n\
    \  cin >> p1 >> p2 >> p3 >> k >> s;\n  Polygon<int> g({p1, p2, p3});\n  cout <<\
    \ (g.where(k) * g.where(s) < 0 ? \"OK\" : \"NG\") << '\\n';\n }\n return 0;\n\
    }\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0143\"\
