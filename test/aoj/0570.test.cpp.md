...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/0570.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/0570\"\
    ...
    \ dfa_a(alp, 0, tr_a, ac, n + 1), dfa_b(alp, 0, tr_b, ac, n + 1);\n auto tr_m=\
    \ [&](int s, int c) { return (s * 10 + c) % M; };\n Automaton dfa_m(alp, 0, tr_m,\
    ...
    \ return {-1, -1};\n   else return {c, 1};\n  } else {\n   if (t == 0) return\
    \ {-1, -1};\n   else return {c, 0};\n  }\n  return {-1, -1};\n };\n Automaton\
    \ dfa_zz(\n     alp, state_t{-2, -2}, tr_zz, [&](state_t) { return true; }, state_t{-1,\
