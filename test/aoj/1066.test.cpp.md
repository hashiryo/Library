...
data:
  ...
  attributes:
    ...
    ERROR: '0.00000001'
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/1066
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/1066
  bundledCode: "#line 1 \"test/aoj/1066.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1066\"\
    ...
    \ return Polygon(ps);\n}\n}\n#line 10 \"test/aoj/1066.test.cpp\"\nusing namespace\
    ...
    \ 0}, R);\n  while (Q--) {\n   Real mn= M_PI * 2;\n   int nxt= -1;\n   for (int\
    \ i= N; i--;) {\n    if (cur == i) continue;\n    Circle<Real> d(g[cur], dist(g[cur],\
    \ g[i]));\n    auto cp= cross_points(c, d);\n    auto th= angle(g[i] - g[cur],\
    \ cp[0] - g[cur]);\n    if (mn > th) mn= th, nxt= i;\n   }\n   g= rotate(g[cur],\
    \ mn)(g);\n   cur= nxt;\n   cout << g[cur].x << \" \" << g[cur].y << '\\n';\n\
    \  }\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1066\"\n#define\
    \ ERROR \"0.00000001\"\n#include <iostream>\n#include <iomanip>\n#include <vector>\n\
  ...
  verifiedWith: []
documentation_of: test/aoj/1066.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/1066.test.cpp
- /verify/test/aoj/1066.test.cpp.html
