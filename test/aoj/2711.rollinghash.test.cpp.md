...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/2711.rollinghash.test.cpp\"\n#define PROBLEM \"\
    ...
    \ r)(gen);\n}\n#line 6 \"test/aoj/2711.rollinghash.test.cpp\"\nusing namespace\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/2711\"\n#include\
    ...
    \ string S;\n cin >> S;\n RH rh(S);\n int Q;\n cin >> Q;\n while (Q--) {\n  int\
    \ l, r, t;\n  cin >> l >> r >> t, l--;\n  auto a= rh.sub(l, r - t), b= rh.sub(l\
    \ + t, r);\n  int s= lcp(a, b);\n  if (s >= r - (l + t)) {\n   cout << \"Yes\"\
    \ << '\\n';\n  } else if (a.get_hash(s + 1) == b.get_hash(s + 1)) {\n   cout <<\
    \ \"Yes\" << '\\n';\n  } else if (s + t < r - l - t && a.get_hash(s + 1, s + t)\
    \ == b.get_hash(s + 1, s + t) && a.get_hash(s + t + 1) == b.get_hash(s + t + 1)\
    \ && S[l + s] == S[l + s + t + t]) {\n   cout << \"Yes\" << '\\n';\n  } else {\n\
    \   cout << \"No\" << '\\n';\n  }\n }\n return 0;\n}"
  dependsOn:
  - src/Math/ModInt.hpp
