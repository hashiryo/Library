...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/1267
    links:
    - https://onlinejudge.u-aizu.ac.jp/problems/1267
  bundledCode: "#line 1 \"test/aoj/1267.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1267\"\
    ...
    \ return d.build(), d;\n}\n}\n#line 5 \"test/aoj/1267.test.cpp\"\nusing namespace\
    \ std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(false);\n using namespace\
    \ geo;\n using R= long double;\n R mx= 10000;\n Convex<R> all({{0, 0}, {mx, 0},\
    \ {mx, mx}, {0, mx}});\n for (int n; cin >> n && n;) {\n  vector<Point<R>> ps(n);\n\
    \  for (int i= 0; i < n; ++i) cin >> ps[i];\n  auto cv= all;\n  for (int i= 0;\
    \ i < n; ++i) cv= cv.cut(line_through(ps[i], ps[(i + 1) % n]));\n  cout << (cv.size()\
    \ > 0) << '\\n';\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/1267\"\n#include\
  ...
  verifiedWith: []
documentation_of: test/aoj/1267.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/1267.test.cpp
- /verify/test/aoj/1267.test.cpp.html
