...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0153
    links:
    - https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0153
  bundledCode: "#line 1 \"test/aoj/0153.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0153\"\
    ...
    \ + c.r * f, !f));\n  }\n }\n return ls;\n}\n}\n#line 5 \"test/aoj/0153.test.cpp\"\
    \nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using namespace geo;\n for (int x, y; cin >> x >> y && x;) {\n  Point<int> p1(x,\
    \ y), p2, p3;\n  cin >> p2 >> p3;\n  Polygon<int> g({p1, p2, p3});\n  Circle<int>\
    \ c;\n  cin >> c.o >> c.r;\n  if (min({c.where(p1), c.where(p2), c.where(p3)})\
    \ != -1) {\n   cout << \"b\" << '\\n';\n   continue;\n  }\n  int d= 1e9;\n  for\
    \ (const auto &e: g.edges()) d= min(d, dist2(e, c.o));\n  if (int s= d - c.r *\
    \ c.r; g.where(c.o) != -1 && s >= 0) cout << \"a\" << '\\n';\n  else if (s <=\
    \ 0) cout << \"c\" << '\\n';\n  else cout << \"d\" << '\\n';\n }\n return 0;\n\
    }\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Final/0153\"\
  ...
  verifiedWith: []
documentation_of: test/aoj/0153.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0153.test.cpp
- /verify/test/aoj/0153.test.cpp.html
