...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Prelim/0204
    links:
    - https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Prelim/0204
  bundledCode: "#line 1 \"test/aoj/0204.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Prelim/0204\"\
    ...
    \ (int i= 0; i < N; ++i)\n    if (!used[i]) used[i]|= cross_points(cs[i], s).size()\
    \ > 0;\n  }\n  cout << ans << '\\n';\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/challenges/sources/PCK/Prelim/0204\"\
  ...
  verifiedWith: []
documentation_of: test/aoj/0204.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/0204.test.cpp
- /verify/test/aoj/0204.test.cpp.html
