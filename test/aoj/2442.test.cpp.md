...
data:
  ...
  attributes:
    ...
    ERROR: '0.00000001'
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2442
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2442
  bundledCode: "#line 1 \"test/aoj/2442.test.cpp\"\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2442\"\
    ...
    \ isok= true;\n  for (int i= 0; i < N / 2; i++) isok&= ans == (ps[i] + ps[N /\
    \ 2 + i]) / 2;\n  if (isok) cout << fixed << setprecision(12) << ans << endl;\n\
    \  else cout << \"NA\" << endl;\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2442\"\
    \n#define ERROR \"0.00000001\"\n#include <iostream>\n#include <iomanip>\n#include\
    ...
    \ i++) cin >> ps[i];\n if (N & 1) cout << \"NA\" << endl;\n else {\n  Point ans=\
    \ (ps[0] + ps[N / 2]) / 2;\n  bool isok= true;\n  for (int i= 0; i < N / 2; i++)\
    \ isok&= ans == (ps[i] + ps[N / 2 + i]) / 2;\n  if (isok) cout << fixed << setprecision(12)\
    \ << ans << endl;\n  else cout << \"NA\" << endl;\n }\n return 0;\n}"
  dependsOn:
