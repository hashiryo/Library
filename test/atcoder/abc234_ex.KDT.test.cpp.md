...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/abc234_ex.KDT.test.cpp\"\n#define PROBLEM \"\
    https://atcoder.jp/contests/abc234/tasks/abc234_Ex\"\n// https://atcoder.jp/contests/abc234/tasks/abc234_h\n\
    ...
    #line 7 \"test/atcoder/abc234_ex.KDT.test.cpp\"\n\n//  \u5186\u5F62\u30AF\u30A8\
    \u30EA\nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ int N, K;\n cin >> N >> K;\n vector<array<int, 3>> xy(N);\n for (int i= 0; i\
    \ < N; ++i) cin >> xy[i][0] >> xy[i][1], xy[i][2]= i;\n KDTree<int, 2, int> kdt(xy);\n\
    \ vector<pair<int, int>> ans;\n for (int i= N; i--;) {\n  auto ps= kdt.enum_ball(xy[i][0],\
    \ xy[i][1], K);\n  for (auto p: ps)\n   if (i < p) ans.emplace_back(i + 1, p +\
  ...
  verifiedWith: []
documentation_of: test/atcoder/abc234_ex.KDT.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/abc234_ex.KDT.test.cpp
- /verify/test/atcoder/abc234_ex.KDT.test.cpp.html
