...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/arc033_4.lagrange.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/arc033/tasks/arc033_4\"\n\n#include <bits/stdc++.h>\n\
    ...
    \ * finv[i] * finv[n - i];\n    res += (n - i) & 1 ? -tmp : tmp;\n  }\n  return\
    \ res;\n}\n#line 6 \"test/atcoder/arc033_4.lagrange.test.cpp\"\n\nusing namespace\
    \ std;\nsigned main() {\n  cin.tie(0);\n  ios::sync_with_stdio(0);\n  using Mint\
    \ = ModInt<int(1e9 + 7)>;\n  int N;\n  cin >> N;\n  vector<Mint> A(N + 1);\n \
    \ for (int i = 0; i <= N; i++) cin >> A[i];\n  int T;\n  cin >> T;\n  cout <<\
    \ lagrange_interpolation<Mint>(A, T) << '\\n';\n  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/atcoder/arc033_4.lagrange.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/arc033_4.lagrange.test.cpp
- /verify/test/atcoder/arc033_4.lagrange.test.cpp.html
