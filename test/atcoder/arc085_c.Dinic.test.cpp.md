...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/arc085_c.Dinic.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/arc085/tasks/arc085_c\"\n\n#include <bits/stdc++.h>\n\
    ...
    \ std::make_pair(ret, sol);\n}\n#line 7 \"test/atcoder/arc085_c.Dinic.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/arc085/tasks/arc085_c\"\n\n\
    ...
    \ == 1 && xj == 0 && (j + 1) % (i + 1) == 0) return INF;\n    if (xj == 1 && xi\
    \ == 0 && (i + 1) % (j + 1) == 0) return INF;\n    return 0ll;\n  };\n  using\
    \ MF = MaxFlow<Dinic<long long>>;\n  auto [ans, x] = monge_mincut<MF>(N, 2, theta,\
    \ phi);\n  cout << -ans << '\\n';\n  return 0;\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/atcoder/arc085_c.Dinic.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/arc085_c.Dinic.test.cpp
- /verify/test/atcoder/arc085_c.Dinic.test.cpp.html
