...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/abc208_e.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc208/tasks/abc208_e\"\
    ...
    \ & dfa_k;\n int64_t ans= 0, pw= 1;\n for (int i= 1; i < n; ++i, pw*= 10) ans+=\
    \ dfa_k.num<int64_t>(i) - pw;\n ans+= dfa.num<int64_t>(n) - pw;\n cout << ans\
    \ << '\\n';\n return 0;\n}\n"
