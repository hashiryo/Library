...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc275/tasks/abc275_Ex
    links:
    - https://atcoder.jp/contests/abc275/tasks/abc275_Ex
    - https://atcoder.jp/contests/abc275/tasks/abc275_h
  bundledCode: "#line 1 \"test/atcoder/abc275_ex.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc275/tasks/abc275_Ex\"\
    \n// https://atcoder.jp/contests/abc275/tasks/abc275_h\n#include <iostream>\n\
    ...
    #line 5 \"src/Optimization/PiecewiseLinearConvexfunction.hpp\"\n#include <sstream>\n\
    ...
    \ ++i) cin >> B[i];\n CartesianTree ct(B, false);\n int root= ct.root();\n vector<PiecewiseLinearConvexfunction<>>\
...
layout: document
redirect_from:
- /verify/test/atcoder/abc275_ex.test.cpp
- /verify/test/atcoder/abc275_ex.test.cpp.html
