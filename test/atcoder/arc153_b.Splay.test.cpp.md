...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/arc153_b.Splay.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/arc153/tasks/arc153_b\"\n\n// reverse \u306E verify\n\
    ...
    \ l, update(rt), v;\n }\n};\n#line 9 \"test/atcoder/arc153_b.Splay.test.cpp\"\n\
    using namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using Splay= SplayTree<int, true>;\n int H, W;\n cin >> H >> W;\n vector<string>\
    \ A(H);\n for (int i= 0; i < H; ++i) cin >> A[i];\n Splay row, col;\n {\n  vector<int>\
    \ v(H);\n  iota(v.begin(), v.end(), 0);\n  row= Splay(v);\n }\n {\n  vector<int>\
    \ v(W);\n  iota(v.begin(), v.end(), 0);\n  col= Splay(v);\n }\n int Q;\n cin >>\
    \ Q;\n while (Q--) {\n  int a, b;\n  cin >> a >> b;\n  row.reverse(0, a), row.reverse(a,\
  ...
  verifiedWith: []
documentation_of: test/atcoder/arc153_b.Splay.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/arc153_b.Splay.test.cpp
- /verify/test/atcoder/arc153_b.Splay.test.cpp.html
