...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/abc160_f.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc160/tasks/abc160_f\"\
    ...
    \ [&](const Data &l, const Data &r) { return Data{l.first + r.first, F::nCr(l.first\
    \ + r.first, l.first) * l.second * r.second}; };\n auto put_vertex= [&](int, const\
    \ Data &d) { return Data{d.first + 1, d.second}; };\n for (auto [_, x]: Rerooting<Data>(g,\
    \ put_edge, op, Data{0, 1}, put_vertex)) cout << x << '\\n';\n return 0;\n}\n"
