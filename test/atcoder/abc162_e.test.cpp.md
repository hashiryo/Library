...
data:
  ...
  bundledCode: "#line 1 \"test/atcoder/abc162_e.test.cpp\"\n#define PROBLEM \"https://atcoder.jp/contests/abc162/tasks/abc162_e\"\
    ...
    \ * n / 2; j <= M; j+= n) lf[j]+= n * !lf[j];\n  }\n}\nListRange<int> enumerate_primes()\
  ...
  verifiedWith: []
documentation_of: test/atcoder/abc162_e.test.cpp
layout: document
redirect_from:
- /verify/test/atcoder/abc162_e.test.cpp
- /verify/test/atcoder/abc162_e.test.cpp.html
