...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/vertex_set_path_composite.HLD.test.cpp\"\n#define\
    ...
    \ i - n + last;\n   } else val= tmp;\n  }\n  return -1;\n }\nprivate:\n const\
    \ int n;\n std::vector<T> dat;\n};\n#line 9 \"test/yosupo/vertex_set_path_composite.HLD.test.cpp\"\
    ...
    \ vec[tree.to_seq(v)]= {a[v], b[v]};\n SegmentTree<Mono> seg1(vec);\n reverse(vec.begin(),\
    \ vec.end());\n SegmentTree<Mono> seg2(vec);\n while (Q--) {\n  bool op;\n  cin\
    \ >> op;\n  if (op) {\n   int u, v;\n   Mint x;\n   cin >> u >> v >> x;\n   auto\
    \ f= Mono::ti();\n   for (auto [s, t]: tree.path(u, v)) f= Mono::op(f, s < t ?\
    \ seg1.fold(s, t + 1) : seg2.fold(N - s - 1, N - t));\n   cout << f[0] * x + f[1]\
    \ << '\\n';\n  } else {\n   int p;\n   Mint c, d;\n   cin >> p >> c >> d;\n  \
    \ int i= tree.to_seq(p);\n   seg1.set(i, {c, d});\n   seg2.set(N - i - 1, {c,\
    \ d});\n  }\n }\n return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/vertex_set_path_composite\"\
    ...
    \ seg2(vec);\n while (Q--) {\n  bool op;\n  cin >> op;\n  if (op) {\n   int u,\
    \ v;\n   Mint x;\n   cin >> u >> v >> x;\n   auto f= Mono::ti();\n   for (auto\
    \ [s, t]: tree.path(u, v)) f= Mono::op(f, s < t ? seg1.fold(s, t + 1) : seg2.fold(N\
    \ - s - 1, N - t));\n   cout << f[0] * x + f[1] << '\\n';\n  } else {\n   int\
    \ p;\n   Mint c, d;\n   cin >> p >> c >> d;\n   int i= tree.to_seq(p);\n   seg1.set(i,\
    \ {c, d});\n   seg2.set(N - i - 1, {c, d});\n  }\n }\n return 0;\n}"
  dependsOn:
