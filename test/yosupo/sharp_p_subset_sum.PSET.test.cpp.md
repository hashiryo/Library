...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/sharp_p_subset_sum.PSET.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\n#include <bits/stdc++.h>\n\
    ...
    \ i) { return h(i + os) * iv; });\n      FPS t1([h0 = log<mod_t, _Nm>(t0).handle(),\
    \ kk](int i) {\n        return h0(i) * kk;\n      });\n      s.emplace([vk = v.pow(k),\
    \ h1 = exp<mod_t, _Nm>(t1).handle()](int i) {\n        return h1(i) * vk;\n  \
    ...
    \ });\n  }\n};\n#line 5 \"test/yosupo/sharp_p_subset_sum.PSET.test.cpp\"\nusing\
  ...
  requiredBy: []
  timestamp: '2022-11-08 15:18:24+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/yosupo/sharp_p_subset_sum.PSET.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/sharp_p_subset_sum.PSET.test.cpp
- /verify/test/yosupo/sharp_p_subset_sum.PSET.test.cpp.html
