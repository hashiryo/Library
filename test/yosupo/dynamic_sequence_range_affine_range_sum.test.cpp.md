...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/dynamic_sequence_range_affine_range_sum.test.cpp\"\
    ...
    \ *t= new Node{*mid};\n  return t->par= par, t->ch[0]= build(bg, mid, t), t->ch[1]=\
    \ build(mid + 1, ed, t), pushup(t);\n }\n static inline Node *build(size_t bg,\
    \ size_t ed, const T &val, Node *par) {\n  if (bg == ed) return nullptr;\n  size_t\
    \ mid= bg + (ed - bg) / 2;\n  Node *t= new Node{val};\n  return t->par= par, t->ch[0]=\
    \ build(bg, mid, val, t), t->ch[1]= build(mid + 1, ed, val, t), pushup(t);\n }\n\
    ...
    \ {\n   M::mapping(t->sum, x, t->size);\n   if constexpr (reversible) M::mapping(t->rsum,\
    ...
    \ else splay(t, b), t->ch[0]->par= nullptr, splay(t->ch[0], a - 1), t->ch[0]->par=\
    \ t, t= t->ch[0]->ch[1];\n }\npublic:\n SplayTree(Node *t= nullptr): root(t) {}\n\
    \ SplayTree(size_t n, T val= T()) { root= build(0, n, val, nullptr); }\n SplayTree(const\
    \ T *bg, const T *ed) { root= build(bg, ed, nullptr); }\n SplayTree(const std::vector<T>\
    \ &ar): SplayTree(ar.data(), ar.data() + ar.size()) {}\n std::vector<T> dump()\
    \ {\n  std::vector<T> ret(size());\n  return dump(ret.begin(), root), ret;\n }\n\
    \ static std::string which_available() {\n  std::string ret= \"\";\n  if constexpr\
    \ (semigroup_v<M>) ret+= \"\\\"fold\\\" \";\n  else ret+= \"\\\"at\\\" \";\n \
    \ if constexpr (dual_v<M>) ret+= \"\\\"apply\\\" \";\n  if constexpr (reversible)\
    \ ret+= \"\\\"reverse\\\" \";\n  return ret;\n }\n size_t size() { return root\
    \ ? root->size : 0; }\n void clear() { root= nullptr; }\n template <class L= M>\
    \ const std::enable_if_t<semigroup_v<L>, T> &operator[](size_t k) { return get(k);\
    ...
    \ T val) { splay(root, k), root->val= val, pushup(root); }\n T fold(size_t a,\
