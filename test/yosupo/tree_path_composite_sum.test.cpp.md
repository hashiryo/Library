...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/tree_path_composite_sum.test.cpp\"\n#define\
    ...
    \ 0);\n using Data= pair<Mint, int>;\n auto put_edge= [&](int, int e, const Data\
    \ &d) { return Data{b[e] * d.first + c[e], d.second}; };\n auto op= [&](const\
    \ Data &l, const Data &r) { return Data{l.first + r.first, l.second + r.second};\
    \ };\n auto put_vertex= [&](int v, const Data &d) { return Data{d.first + a[v],\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/tree_path_composite_sum\"\
    ...
    \ { return Data{b[e] * d.first + c[e], d.second}; };\n auto op= [&](const Data\
    \ &l, const Data &r) { return Data{l.first + r.first, l.second + r.second}; };\n\
    \ auto put_vertex= [&](int v, const Data &d) { return Data{d.first + a[v], d.second\
    \ + 1}; };\n Rerooting<Data> dp(g, put_edge, op, Data{0, 0}, put_vertex);\n for\
