...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/dynamic_tree_vertex_set_path_composite.LCT.test.cpp\"\
    ...
    \ &operator<<(ostream &os, const D &r) { return os << r.val(); }\n  friend istream\
    \ &operator>>(istream &is, D &r) {\n    long long v;\n    return is >> v, r =\
    \ D(v), is;\n  }\n};\ntemplate <class B>\nstruct ModInt_Na : public B, public\
    \ ModIntImpl<ModInt_Na<B>> {\n  using DUint = conditional_t<is_same_v<typename\
    ...
    \ 6 \"test/yosupo/dynamic_tree_vertex_set_path_composite.LCT.test.cpp\"\nusing\
