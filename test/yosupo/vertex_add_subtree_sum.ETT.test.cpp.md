...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/vertex_add_subtree_sum.ETT.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_subtree_sum\"\n#include\
  ...
  verifiedWith: []
documentation_of: test/yosupo/vertex_add_subtree_sum.ETT.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/vertex_add_subtree_sum.ETT.test.cpp
- /verify/test/yosupo/vertex_add_subtree_sum.ETT.test.cpp.html
