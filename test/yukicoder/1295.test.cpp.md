...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1295.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1295\"\
    ...
    \ 1)] : dp1[v]; }\n};\n#line 8 \"test/yukicoder/1295.test.cpp\"\nusing namespace\
    ...
    \ (u == mx2[v]) return 3;\n  return 4;\n };\n auto op= [&](int l, int r) { return\
    \ l + r; };\n auto put_vertex= [&](int v, int d) { return d; };\n for (auto x:\
    \ Rerooting<int>(g, put_edge, op, 0, put_vertex)) cout << (x <= 2 ? \"Yes\" :\
    \ \"No\") << '\\n';\n return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1295\"\n#include <iostream>\n\
    ...
    \ for (int i= 0; i < N - 1; ++i) cin >> g[i], --g[i];\n g.build(N, 0);\n vector<int>\
    \ mx(N), mx2(N), mn(N);\n for (int i= 0; i < N; ++i) {\n  vector<int> vs;\n  for\
    \ (auto e: g(i)) vs.push_back(g[e] - i);\n  sort(vs.begin(), vs.end());\n  int\
    \ n= vs.size();\n  mx[i]= vs[n - 1], mn[i]= vs[0];\n  mx2[i]= n > 1 ? vs[n - 2]\
    \ : -1;\n }\n auto put_edge= [&](int v, int e, int d) {\n  int u= g[e] - v;\n\
    \  if (d >= 4 || (d == 3 && v != mx[u])) return 4;\n  if (d == 0 && v == mn[u])\
    \ return 0;\n  if (u == mx[v] || u == mn[v]) return 2;\n  if (u == mx2[v]) return\
    \ 3;\n  return 4;\n };\n auto op= [&](int l, int r) { return l + r; };\n auto\
    \ put_vertex= [&](int v, int d) { return d; };\n for (auto x: Rerooting<int>(g,\
    \ put_edge, op, 0, put_vertex)) cout << (x <= 2 ? \"Yes\" : \"No\") << '\\n';\n\
    \ return 0;\n}"
  dependsOn:
  - src/Graph/Graph.hpp
