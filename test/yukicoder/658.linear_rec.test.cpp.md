...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/658.linear_rec.test.cpp\"\n#define PROBLEM\
    ...
    \ - j];\n return div_at<K>(p, c, k);\n}\n#line 5 \"test/yukicoder/658.linear_rec.test.cpp\"\
    \nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using Mint= ModInt<17>;\n int Q;\n cin >> Q;\n while (Q--) {\n  long long n;\n\
    \  cin >> n;\n  cout << linear_recurrence<Mint>({1, 1, 1, 1}, {0, 0, 0, 1}, n\
    \ - 1) << \"\\n\";\n }\n return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yukicoder/658.linear_rec.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/658.linear_rec.test.cpp
- /verify/test/yukicoder/658.linear_rec.test.cpp.html
