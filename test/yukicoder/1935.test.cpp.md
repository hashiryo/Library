...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1935
    links:
    - https://yukicoder.me/problems/no/1935
  bundledCode: "#line 1 \"test/yukicoder/1935.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1935\"\
    ...
    \ n - r + 1;\n  return {pth[0], pth[1], cnt, pth[2]};\n }\n};\n#line 5 \"test/yukicoder/1935.test.cpp\"\
    ...
    \ a[2], V[2]);\n  f(a[2], a[3], V[3]);\n  f(a[3], a[0], V[0]);\n  return a;\n\
    \ };\n Dat init= {V[0], 0, 0, 0};\n Period<Dat> p(g, {init});\n auto [q, r]= div(N,\
    \ 4LL);\n auto v= p.jump(init, q);\n for (int i= 0; i < r; ++i) f(v[i], v[i +\
    \ 1], V[i + 1]);\n cout << v[0] << ' ' << v[1] << ' ' << v[2] << ' ' << v[3] <<\
    \ '\\n';\n return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1935\"\n#include <iostream>\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1935.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1935.test.cpp
- /verify/test/yukicoder/1935.test.cpp.html
