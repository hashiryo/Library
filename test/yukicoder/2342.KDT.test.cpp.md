...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2342.KDT.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2342\"\
    ...
    \ <class T> static constexpr bool tuple_like_v= false;\ntemplate <class... Args>\
    \ static constexpr bool tuple_like_v<std::tuple<Args...>> = true;\ntemplate <class\
    \ T, class U> static constexpr bool tuple_like_v<std::pair<T, U>> = true;\ntemplate\
    ...
    #line 12 \"test/yukicoder/2342.KDT.test.cpp\"\nusing namespace std;\nusing Mint=\
    \ ModInt<998244353>;\nstruct RaffineQ {\n using T= Mint;\n using E= array<Mint,\
