...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1124.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1124\"\
    ...
    \ 1)] : dp1[v]; }\n};\n#line 7 \"test/yukicoder/1124.test.cpp\"\nusing namespace\
    \ std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n using Mint=\
    \ ModInt<int(1e9 + 7)>;\n int N;\n cin >> N;\n Graph g(N - 1);\n for (int i= 0;\
    \ i < N - 1; ++i) cin >> g[i], --g[i];\n g.build(N, 0);\n using Data= array<Mint,\
    \ 2>;\n static constexpr Mint iv2= Mint(1) / 2;\n auto put_edge= [&](int, int,\
    \ const Data &d) { return Data{d[0] * iv2, d[1] * iv2}; };\n auto op= [&](const\
    \ Data &l, const Data &r) { return Data{l[0] + r[0], l[1] + l[0] * r[0] * 2 +\
    \ r[1]}; };\n auto put_vertex= [&](int, const Data &d) { return Data{d[0] + 1,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1124\"\n#include <iostream>\n\
    ...
    \ Data{d[0] * iv2, d[1] * iv2}; };\n auto op= [&](const Data &l, const Data &r)\
    \ { return Data{l[0] + r[0], l[1] + l[0] * r[0] * 2 + r[1]}; };\n auto put_vertex=\
    \ [&](int, const Data &d) { return Data{d[0] + 1, d[1] + d[0] * 2 + 1}; };\n Mint\
