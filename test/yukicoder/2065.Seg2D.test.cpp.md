...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2065.Seg2D.test.cpp\"\n#define PROBLEM \"\
    https://yukicoder.me/problems/no/2065\"\n#include <iostream>\n#include <vector>\n\
    ...
    \ x, pos_t y) const { return val[xy2i(x, y) + id[2]]; }\n};\n#line 9 \"test/yukicoder/2065.Seg2D.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2023-11-17 11:33:00+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/yukicoder/2065.Seg2D.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2065.Seg2D.test.cpp
- /verify/test/yukicoder/2065.Seg2D.test.cpp.html
