...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2454.RH.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2454\"\
    ...
    \ l, int64_t r) { return l + rng() % (r - l); }\n#line 8 \"test/yukicoder/2454.RH.test.cpp\"\
    \nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using Mint= ModInt<998244353>;\n using K= Pointwise<Mint, Mint>;\n using RH=\
    \ RollingHash<K>;\n RH::init({rng(), rng()});\n int T;\n cin >> T;\n while (T--)\
    \ {\n  int N;\n  string S;\n  cin >> N >> S;\n  RH rh(S);\n  int ans= 0;\n  for\
    \ (int i= 1; i < N; ++i) ans+= rh.sub(0, i) < rh.sub(i);\n  cout << ans << '\\\
    n';\n }\n return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2454.RH.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2454.RH.test.cpp
- /verify/test/yukicoder/2454.RH.test.cpp.html
