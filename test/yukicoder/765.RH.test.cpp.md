...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/765.RH.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/765\"\
    ...
    \ l, int64_t r) { return l + rng() % (r - l); }\n#line 9 \"test/yukicoder/765.RH.test.cpp\"\
    ...
    \ nn + m * 2);\n  }\n  if (k + n + 1 <= N) {\n   int m= lcp(rh.sub(j + n), rhrv.sub(k\
    \ + n + 1));\n   ans= max(ans, nn + m * 2);\n  }\n }\n cout << ans << '\\n';\n\
    \ return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/765\"\n#include <iostream>\n\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/765.RH.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/765.RH.test.cpp
- /verify/test/yukicoder/765.RH.test.cpp.html
