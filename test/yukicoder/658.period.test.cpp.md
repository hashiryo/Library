...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/658.period.test.cpp\"\n#define PROBLEM \"\
    https://yukicoder.me/problems/no/658\"\n#include <iostream>\n#include <array>\n\
    #line 2 \"src/Misc/Period.hpp\"\n#include <map>\n#include <unordered_map>\n#line\
    \ 3 \"src/Graph/HeavyLightDecomposition.hpp\"\n#include <cassert>\n#line 2 \"\
    ...
    \ l= n - l, r= n - r + 1;\n  return p1;\n }\n};\n#line 5 \"test/yukicoder/658.period.test.cpp\"\
    \nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using Dat= array<int, 4>;\n auto f= [](const Dat &x) -> Dat { return {x[1],\
    \ x[2], x[3], (x[0] + x[1] + x[2] + x[3]) % 17}; };\n Dat init{0, 0, 0, 1};\n\
    \ Period<Dat> p(f, {init});\n int Q;\n cin >> Q;\n while (Q--) {\n  long long\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/658\"\n#include <iostream>\n\
    ...
    \ main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n using Dat= array<int, 4>;\n\
    \ auto f= [](const Dat &x) -> Dat { return {x[1], x[2], x[3], (x[0] + x[1] + x[2]\
    \ + x[3]) % 17}; };\n Dat init{0, 0, 0, 1};\n Period<Dat> p(f, {init});\n int\
    \ Q;\n cin >> Q;\n while (Q--) {\n  long long n;\n  cin >> n;\n  cout << p.jump(init,\
    \ n - 1)[0] << '\\n';\n }\n return 0;\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/yukicoder/658.period.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/658.period.test.cpp
- /verify/test/yukicoder/658.period.test.cpp.html
