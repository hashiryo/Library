...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/685.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/685\"\
    ...
    \ T &x, const auto &, auto) { return x; }, T(1));\n }\n};\n#line 6 \"test/yukicoder/685.test.cpp\"\
    \nusing namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ using Mint= ModInt<int(1e9 + 7)>;\n using symbol_t= array<int, 2>;\n vector<symbol_t>\
    \ alp;\n for (int i= 0; i < 2; ++i)\n  for (int j= 0; j < 2; ++j) alp.push_back(symbol_t{i,\
    \ j});\n int64_t N;\n cin >> N;\n auto tr_le= [&](int64_t s, symbol_t c) { return\
    \ (s - c[1] + 2) / 2 - 1; };\n Automaton dfa_le(\n     alp, N, tr_le, [](int64_t)\
    \ { return true; }, int64_t(-1));\n auto tr_xy= [&](bool s, symbol_t c) {\n  if\
    \ (c[0] < c[1]) s= 1;\n  else if (c[0] > c[1]) s= 0;\n  return s;\n };\n Automaton\
    \ dfa_xy(alp, false, tr_xy, [](bool s) { return s; });\n auto tr_ax= [&](bool\
    \ s, symbol_t c) {\n  bool a= c[0] & c[1], x= c[0] ^ c[1];\n  if (a < x) s= 1;\n\
    \  else if (a > x) s= 0;\n  return s;\n };\n Automaton dfa_ax(alp, false, tr_ax,\
  ...
  requiredBy: []
  timestamp: '2023-04-23 16:42:24+09:00'
