...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/685.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/685\"\
    ...
    \ T &x, const auto &, auto) { return x; }, T(1));\n }\n};\n#line 7 \"test/yukicoder/685.test.cpp\"\
    ...
    \ [&](bool s, symbol_t c) {\n  if (c[0] < c[1]) s= 1;\n  else if (c[0] > c[1])\
    \ s= 0;\n  return s;\n };\n Automaton dfa_xy(alp, false, tr_xy, [](bool s) { return\
    \ s; });\n auto tr_ax= [&](bool s, symbol_t c) {\n  bool a= c[0] & c[1], x= c[0]\
    \ ^ c[1];\n  if (a < x) s= 1;\n  else if (a > x) s= 0;\n  return s;\n };\n Automaton\
    \ dfa_ax(alp, false, tr_ax, [](bool s) { return s; });\n auto tr_xo= [&](bool\
    \ s, symbol_t c) {\n  bool x= c[0] ^ c[1], o= c[0] | c[1];\n  if (x < o) s= 1;\n\
    \  else if (x > o) s= 0;\n  return s;\n };\n Automaton dfa_xo(alp, false, tr_xo,\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/685\"\n#include <iostream>\n\
    ...
    \ N;\n cin >> N;\n auto tr_le= [&](int64_t s, symbol_t c) { return (s - c[1] +\
    \ 2) / 2 - 1; };\n Automaton dfa_le(\n     alp, N, tr_le, [](int64_t) { return\
    \ true; }, int64_t(-1));\n auto tr_xy= [&](bool s, symbol_t c) {\n  if (c[0] <\
    \ c[1]) s= 1;\n  else if (c[0] > c[1]) s= 0;\n  return s;\n };\n Automaton dfa_xy(alp,\
    \ false, tr_xy, [](bool s) { return s; });\n auto tr_ax= [&](bool s, symbol_t\
    \ c) {\n  bool a= c[0] & c[1], x= c[0] ^ c[1];\n  if (a < x) s= 1;\n  else if\
    \ (a > x) s= 0;\n  return s;\n };\n Automaton dfa_ax(alp, false, tr_ax, [](bool\
    \ s) { return s; });\n auto tr_xo= [&](bool s, symbol_t c) {\n  bool x= c[0] ^\
    \ c[1], o= c[0] | c[1];\n  if (x < o) s= 1;\n  else if (x > o) s= 0;\n  return\
    \ s;\n };\n Automaton dfa_xo(alp, false, tr_xo, [](bool s) { return s; });\n auto\
    \ dfa= dfa_le & dfa_xy & dfa_ax & dfa_xo;\n cout << dfa.num<Mint>(60) << '\\n';\n\
    \ return 0;\n}"
  dependsOn:
  - src/Math/ModInt.hpp
  ...
  requiredBy: []
  timestamp: '2023-04-23 18:34:38+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yukicoder/685.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/685.test.cpp
- /verify/test/yukicoder/685.test.cpp.html
