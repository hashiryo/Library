...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1297.LiCT.1.test.cpp\"\n#define PROBLEM \"\
    ...
    \ a, long long b) { return (__int128_t)a * x + b; }, -1e17, 1e17);\n auto cht1=\
    \ lct.make_tree<MINIMIZE>(), cht2= lct.make_tree<MINIMIZE>();\n cht2.insert(0,\
    \ 0);\n for (long long i= 0;;) {\n  long long a, b, c= C * 2 * i;\n  cin >> a\
    \ >> b, a+= a, b+= b;\n  cht1.insert(a - c, cht2.query(-a - c).first + c * (i\
    \ + 1) + b);\n  if (++i == N) break;\n  cht2.insert(i, cht1.query(i).first + c\
