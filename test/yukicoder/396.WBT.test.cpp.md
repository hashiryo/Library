...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/396.WBT.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/396\"\
    ...
    \ nmi + 1000 >= M_SIZE || nli + 1000 >= L_SIZE;\n }\n};\n#line 7 \"test/yukicoder/396.WBT.test.cpp\"\
    \nusing namespace std;\nstruct RSQ {\n using T= int;\n static T op(T a, T b) {\
    \ return a + b; }\n using commute= void;\n};\nint main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n\
    \ int N, Q;\n cin >> N >> Q;\n WeightBalancedTree<RSQ, true> wbtL(N, 0), wbtR(N,\
    \ 0);\n int now= 0;\n while (Q--) {\n  char x;\n  int t, y, z;\n  cin >> x >>\
    \ t >> y >> z;\n  int dt= t - now;\n  dt%= 2 * N;\n  if (dt > N) swap(wbtL, wbtR),\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/396.WBT.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/396.WBT.test.cpp
- /verify/test/yukicoder/396.WBT.test.cpp.html
