...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/705.LARSCH.test.cpp\"\n#define PROBLEM \"\
    https://yukicoder.me/problems/no/705\"\n#include <iostream>\n#include <algorithm>\n\
    ...
    \ l + 1; i <= m; ++i) check(r, i);\n  rec(rec, m, r);\n };\n return dp[0]= 0,\
    \ check(n, 0), rec(rec, 0, n), dp;\n}\n#line 5 \"test/yukicoder/705.LARSCH.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/705.LARSCH.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/705.LARSCH.test.cpp
- /verify/test/yukicoder/705.LARSCH.test.cpp.html
