...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2122.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2122\"\
    ...
    \ std::is_base_of_v<math_internal::m_b, mod_t>;\ntemplate <class mod_t> constexpr\
    \ bool is_staticmodint_v= std::is_base_of_v<math_internal::s_b, mod_t>;\n#line\
    \ 5 \"src/Math/ModInt.hpp\"\nnamespace math_internal {\n#define CE constexpr\n\
    template <class MP, u64 MOD> struct SB: s_b {\nprotected:\n static CE MP md= MP(MOD);\n\
    };\ntemplate <class Int, class U, class B> struct MInt: public B {\n using Uint=\
    \ U;\n static CE inline auto mod() { return B::md.mod; }\n CE MInt(): x(0) {}\n\
    \ CE MInt(const MInt& r): x(r.x) {}\n template <class T, enable_if_t<is_modint_v<T>,\
    \ nullptr_t> = nullptr> CE MInt(T v): x(B::md.set(v.val() % B::md.mod)) {}\n CE\
    \ MInt(__int128_t n): x(B::md.set((n < 0 ? ((n= (-n) % B::md.mod) ? B::md.mod\
    ...
    \ k);\n}\n#line 6 \"test/yukicoder/2122.test.cpp\"\nusing namespace std;\nsigned\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2122\"\n#include <iostream>\n\
    ...
    \ constexpr int N= 10000;\n using Mint= ModInt<N>;\n string s;\n cin >> s;\n int\
    \ a= stoi(s);\n long long M, L;\n cin >> M >> L;\n FunctionalGraph graph(N);\n\
    \ for (int n= 0; n < N; ++n) {\n  auto x= linear_recurrence<Mint>({n, 1}, {0,\
    \ 1}, M);\n  if (M & 1) x-= 1;\n  graph.add_edge(n, x.val());\n }\n graph.build();\n\
    \ string ans= to_string(graph.jump(a, L));\n ans= string(4 - ans.length(), '0')\
    \ + ans;\n cout << ans << '\\n';\n return 0;\n}"
  dependsOn:
