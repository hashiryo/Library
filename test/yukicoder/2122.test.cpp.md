...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2122.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2122\"\
    ...
    struct m_b {};\nstruct s_b: m_b {};\ntemplate <class mod_t> CE bool is_modint_v=\
    \ is_base_of_v<m_b, mod_t>;\ntemplate <class mod_t> CE bool is_staticmodint_v=\
    \ is_base_of_v<s_b, mod_t>;\ntemplate <class MP, u64 MOD> struct SB: s_b {\nprotected:\n\
    \ static CE MP md= MP(MOD);\n};\ntemplate <class Int, class U, class B> struct\
  ...
  requiredBy: []
  timestamp: '2023-04-23 15:25:54+09:00'
