...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1494.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1494\"\
    ...
    \ 1)] : dp1[v]; }\n};\n#line 8 \"test/yukicoder/1494.test.cpp\"\nusing namespace\
    ...
    \ auto op= [&](Data l, const Data &r) {\n  for (int i= 0; i <= n; ++i) l[i]= max(l[i],\
    \ r[i]);\n  return l;\n };\n auto put_vertex= [&](int, const Data &d) { return\
    \ d; };\n int ans= 0;\n for (const auto &v: Rerooting<Data>(g, put_edge, op, Data(n\
    \ + 1, 0), put_vertex)) ans= max(ans, v[n]);\n cout << ans << '\\n';\n return\
    \ 0;\n}\n"
