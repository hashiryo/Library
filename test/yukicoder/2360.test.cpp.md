...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/2360.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2360\"\
    ...
    \ auto op= [&](const T &l, const T &r) { return T{l.first + r.first, l.second\
    \ + r.second}; };\n auto put_vertex= [&](int v, T d) {\n  ++d.first;\n  d.second*=\
    \ Mint(10).pow(A[v].length());\n  d.second+= Mint(stoll(A[v])) * d.first;\n  return\
    \ d;\n };\n Mint ans= 0;\n for (auto [_, x]: Rerooting<T>(g, put_edge, op, T(0,\
    \ 0), put_vertex)) ans+= x;\n cout << ans << \"\\n\";\n return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2360\"\n#include <iostream>\n\
    ...
    \ int, const T &d) { return d; };\n auto op= [&](const T &l, const T &r) { return\
    \ T{l.first + r.first, l.second + r.second}; };\n auto put_vertex= [&](int v,\
    \ T d) {\n  ++d.first;\n  d.second*= Mint(10).pow(A[v].length());\n  d.second+=\
    \ Mint(stoll(A[v])) * d.first;\n  return d;\n };\n Mint ans= 0;\n for (auto [_,\
    \ x]: Rerooting<T>(g, put_edge, op, T(0, 0), put_vertex)) ans+= x;\n cout << ans\
    \ << \"\\n\";\n return 0;\n}"
  dependsOn:
  - src/Math/ModInt.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/2360.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/2360.test.cpp
- /verify/test/yukicoder/2360.test.cpp.html
