...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1573.enum_quo.test.cpp\"\n#define PROBLEM\
    \ \"https://yukicoder.me/problems/no/1573\"\n// O(\u221AN)\n#include <iostream>\n\
    #line 2 \"src/NumberTheory/enumerate_quotients.hpp\"\n#include <vector>\n#include\
    \ <algorithm>\n#include <tuple>\n#include <cmath>\n#include <cstdint>\n// (q,l,r)\
    \ : i in (l,r], \u230AN/i\u230B = q\nstd::vector<std::tuple<uint64_t, uint64_t,\
    \ uint64_t>> enumerate_quotients(uint64_t N) {\n uint64_t sq= std::sqrt(N), prev=\
    \ N, x;\n std::vector<std::tuple<uint64_t, uint64_t, uint64_t>> ret;\n for (int\
    \ q= 1, n= (sq * sq + sq <= N ? sq : sq - 1); q <= n; ++q) ret.emplace_back(q,\
    ...
    \ return dat[n];\n}\n#line 6 \"test/yukicoder/1573.enum_quo.test.cpp\"\nusing\
    \ namespace std;\nsigned main() {\n cin.tie(0);\n ios::sync_with_stdio(0);\n using\
    \ Mint= ModInt<998244353>;\n int n, m;\n cin >> n >> m;\n Mint ans= 0;\n for (auto\
    \ [q, l, r]: enumerate_quotients(n)) {\n  long long h= min<long long>(m, r);\n\
    \  if (l >= h) continue;\n  ans+= Mint((h * (h + 1) - l * (l + 1)) / 2) * (q *\
    \ (q + 3) / 2);\n }\n cout << ans << '\\n';\n return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1573.enum_quo.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1573.enum_quo.test.cpp
- /verify/test/yukicoder/1573.enum_quo.test.cpp.html
