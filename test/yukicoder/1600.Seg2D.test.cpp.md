...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1600.Seg2D.test.cpp\"\n#define PROBLEM \"\
    ...
    \ 4 \"src/DataStructure/SegmentTree_2D.hpp\"\n#include <numeric>\n#include <map>\n\
    ...
    \ x, pos_t y) const { return val[xy2i(x, y) + id[2]]; }\n};\n#line 12 \"test/yukicoder/1600.Seg2D.test.cpp\"\
    \nusing namespace std;\nstruct RMQ {\n using T= int;\n static T ti() { return\
    ...
    \ g.adjacency_edge(0);\n vector<Mint> dep(N);\n for (int i= 0, v; i < N; ++i)\n\
    \  for (int e: adj[v= tree.to_vertex(i)])\n   if (int u= g[e].to(v); u != tree.parent(v))\
    \ dep[u]= dep[v] + C[e];\n auto dist= [&](int u, int v) { return dep[u] + dep[v]\
