...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/599.RH.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/599\"\
    ...
    \ l, int64_t r) { return l + rng() % (r - l); }\n#line 8 \"test/yukicoder/599.RH.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/599.RH.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/599.RH.test.cpp
- /verify/test/yukicoder/599.RH.test.cpp.html
