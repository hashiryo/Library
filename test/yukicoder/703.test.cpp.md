...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/703.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/703\"\
    ...
    \ l + 1; i <= m; ++i) check(r, i);\n  rec(rec, m, r);\n };\n return dp[0]= 0,\
    \ check(n, 0), rec(rec, 0, n), dp;\n}\n#line 5 \"test/yukicoder/703.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yukicoder/703.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/703.test.cpp
- /verify/test/yukicoder/703.test.cpp.html
