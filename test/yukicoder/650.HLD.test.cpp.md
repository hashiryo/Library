...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/650.HLD.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/650\"\
    ...
    \ i - n + last;\n   } else val= tmp;\n  }\n  return -1;\n }\nprivate:\n const\
    \ int n;\n std::vector<T> dat;\n};\n#line 9 \"test/yukicoder/650.HLD.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/650\"\n#include <iostream>\n\
    ...
    \ int n;\n cin >> n;\n SegmentTree<Monoid> seg(n, I);\n Graph g(n, n - 1);\n for\
    \ (int e= 0; e < n - 1; ++e) cin >> g[e];\n HeavyLightDecomposition hld(g);\n\
    \ for (auto &[u, v]: g)\n  if (hld.in_subtree(u, v)) swap(u, v);\n\n int q;\n\
    \ cin >> q;\n while (q--) {\n  char t;\n  cin >> t;\n  if (t == 'x') {\n   int\
    \ e;\n   cin >> e;\n   Mat X(2, 2);\n   cin >> X[0][0] >> X[0][1] >> X[1][0] >>\
    \ X[1][1];\n   int i= hld.to_seq(g[e].second);\n   seg.set(i, X);\n  } else {\n\
    \   int u, v;\n   cin >> u >> v;\n   Mat ans= I;\n   for (auto [l, r]: hld.path(u,\
    \ v, true)) ans*= seg.fold(l, r + 1);\n   cout << ans[0][0] << \" \" << ans[0][1]\
    \ << \" \" << ans[1][0] << \" \" << ans[1][1] << '\\n';\n  }\n }\n return 0;\n\
    }"
  dependsOn:
  - src/Math/ModInt.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/650.HLD.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/650.HLD.test.cpp
- /verify/test/yukicoder/650.HLD.test.cpp.html
