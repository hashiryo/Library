...
data:
  ...
  code: "#pragma once\n#include <bits/stdc++.h>\n#include \"src/FFT/fps_inv.hpp\"\n\
    ...
    \ div(const std::vector<mod_t> &p, const std::vector<mod_t> &q) {\n using GAp=\
    \ GlobalArray<mod_t, _Nm, 0>;\n using GAq= GlobalArray<mod_t, _Nm, 1>;\n using\
    \ GAr= GlobalArray<mod_t, _Nm, 2>;\n using GA= GlobalArray<mod_t, _Nm, 3>;\n static\
    \ constexpr std::size_t _Nm2= _Nm * 2 / 15;\n using GNA1= GlobalNTTArray<mod_t,\
    \ _Nm2, 1>;\n using GNA2= GlobalNTTArray<mod_t, _Nm2, 2>;\n using GNA3= GlobalNTTArray<mod_t,\
    \ _Nm2, 3>;\n using GNA2D1= GlobalNTTArray2D<mod_t, _Nm2, 16, 1>;\n using GNA2D2=\
    \ GlobalNTTArray2D<mod_t, _Nm2, 16, 2>;\n static constexpr int TH= 128 << (!is_nttfriend<mod_t,\
    \ _Nm2>());\n static constexpr int TH2= 1024 << (!is_nttfriend<mod_t, _Nm2>());\n\
...
layout: document
redirect_from:
- /library/src/FFT/fps_div.hpp
- /library/src/FFT/fps_div.hpp.html
title: "\u5F62\u5F0F\u7684\u51AA\u7D1A\u6570 div"
---
