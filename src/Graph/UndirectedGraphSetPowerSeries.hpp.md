...
data:
  ...
  bundledCode: "#line 2 \"src/Math/SetPowerSeries.hpp\"\n#include <algorithm>\n#include\
    ...
    \ j= __, i= j | _, ___= i; j < ___; ++j, ++i)\n template <typename T> static inline\
    \ void ranked_zeta_tr(const T f[], T ret[][MAX_N + 1], const int sz) {\n  for\
    \ (int S= sz, c; S--;) ret[S][c= __builtin_popcount(S)]= f[S], std::fill_n(ret[S],\
...
## 問題例
[AtCoder Beginner Contest 253 Ex - We Love Forest](https://atcoder.jp/contests/abc253/tasks/abc253_h) (全域木) \
